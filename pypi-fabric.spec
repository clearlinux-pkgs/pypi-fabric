...
Source0  : https://files.pythonhosted.org/packages/bb/5a/21c5e4684dd56cddcecbc36d60f51d3744320d7b95bf02462e86f753404c/fabric-3.0.1.tar.gz
Source1  : https://files.pythonhosted.org/packages/bb/5a/21c5e4684dd56cddcecbc36d60f51d3744320d7b95bf02462e86f753404c/fabric-3.0.1.tar.gz.asc
...
%prep
%setup -q -n fabric-3.0.1
cd %{_builddir}/fabric-3.0.1
pushd ..
cp -a fabric-3.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682972894
